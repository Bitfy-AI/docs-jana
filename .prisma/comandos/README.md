...
1. Comece com `/prisma:especificacao-nova` para aprender o workflow
2. Use `/prisma:especificacao-listar` para ver o que está disponível
3. Verifique `/prisma:especificacao-status [feature]` para detalhes
4. Leia a documentação individual de cada comando para informações completas
