...
Este agente carrega o prompt principal de `.prisma/agentes/implementador.md`.
...
flowchart LR
    ...
    C -->|Lê caminho| D[.prisma/agentes/implementador.md]
...
**`.prisma/agentes/implementador.md`**
